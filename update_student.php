...
if(!$link){
    ...
    if(isset($_POST['update']))
    {
        ...
        $sql="UPDATE student SET name='$name',pass='$pass',MA8391='$sub1',CS8491='$sub2',CS8492='$sub3',CS8451='$sub4',CS8493='$sub5',GE8291='$sub6',email='$email' WHERE regno='$regno'";
...
#header{
    ...
    <body>
        ...
        ?>
           ...
           <h1 style="padding-left: 480px;margin-top:90px"><b>UPDATE STUDENT</b></h1><br>
            <div class="container">
